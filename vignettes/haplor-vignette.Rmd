...
Therefore, we developed _haploR_, a user-friendly R package that connects to Haploreg and Regulome remotedly with methods POST and GET and downloads results in a suitable R format. This package siginificantly saved our time in developing reporting system for our internal genomic analysis pipeline.
...
A data frame (table) wrapped into a _tibble_ object contains results similar to HaploReg uses. Below we describe the columns.

* _chr_: Chromosome, type: numeric
* _pos_hg38_: Position on the human genome, type: numeric.
* _r2_: Linkage dis equilibrium. Type: numeric.
