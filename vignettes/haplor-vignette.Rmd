...
In order to install the \emph{haploR} package, the user must first install R <http://www.r-project.org>. After that, \emph{haploR} (its developer version) can be installed with:
