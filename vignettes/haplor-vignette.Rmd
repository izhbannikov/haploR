...
Therefore, we developed _haploR_, a user-friendly R package that connets to Haploreg and Regulome remotedly with methods POST and GET and downloads results in suitable R format. This package siginificantly saved our time in developing reporting system for our internal genomic analysis pipeline.

Example of workflow is shown in a picture below.

![Workflow](/Users/ilya/Projects/haploR/vignettes/Workflow.png)
...
* _ldThresh_:	LD threshold, r2 (select NA to only show query variants). Default: ```0.8```.
...
* _r2_: Linkage disequelibrium. Type: numeric.
...
* _DNAse_: Type: chararcter.
* _Proteins_: Type: character.
...
* _RefSeq_id_: NCBI Reference Sequence Accesion number. Type: character.
...
* _hits_: Contains information about chromatin structure: method and cell type.
